...
NOTE: I will likely see if thoughtbot will accept these into the official factory_girl project, similar to http://dev.thoughtbot.com/factory_girl/classes/Factory/Syntax/Generate.html
